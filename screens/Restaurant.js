    ...
    return(
      <View style={{ flexDirection: 'row', paddingTop: 10 }}>
        ...
        >
          ...
          >
            <Text stle={{ ...FONTS.h3 }}>{restaurant?.name}</Text>
          </View>
        </View>
      ...
      >
        {
          restaurant?.menu.map((item, index)=> (
            ...
            >
              ...
              {/* Food Details (name and description) */}
              <View
                style={{
                  width: SIZES.width,
                  alignItems: 'center',
              ...
              >
                ...
                <Text style={{...FONTS.body4, textAlign: 'center'}}>{item.description}</Text>
              </View>
    ...
    return(
      <View>
        ...
        >
          ...
          >
            <Text style={{ ...FONTS.h3}}>{getBasketItemCount()} items in a Cart</Text>
            <Text style={{ ...FONTS.h3}}>{sumOrder()}</Text>
          </View>
          {/* end of items in a cart */}
          ...
          >
            <View style={{flexDirection: 'row'}}>
              ...
              />
              <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4}}>Lincoln PI</Text>
            </View>
